...
type RenewAccessTokenResponse struct {
	...
	RenewAccessTokenExpiresAt time.Time `json:"renew_access_token_expires_at"`
}

// RenewAccessToken check if session got from refreshToken is valid or not, if valid -> return new accessToken
func (server *Server) RenewAccessToken(ctx *gin.Context) {
	...
	res := RenewAccessTokenResponse{
		...
		RenewAccessTokenExpiresAt: accessPayload.ExpiredAt,
	}
